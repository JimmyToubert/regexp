...
var app = {
    ...
    onDeviceReady: function() {
        ...
        var regex = '.*\"guid\":(|\")10101(\"|,|\\\\|\\\}).*';
        //testDb('Smartgeo3806121311783874177052375436098933651436526648471', "SELECT * FROM assets WHERE symbolid REGEXP('.*')");
        testDb('Smartgeo3806121311783874177052375436098933651436526648471',
        "SELECT * FROM assets WHERE LOWER(asset) REGEXP('" + regex + "')");
    },
...
function testDb(dbname, request){
    ...
    */
    db.transaction(function(tx){
        console.log('in transaction, request: ' + request);
